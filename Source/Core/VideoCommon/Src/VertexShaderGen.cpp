...
static inline void GenerateVertexShader(T& out, u32 components, API_TYPE api_type)
{
	...
	DeclareUniform(out, api_type, g_ActiveConfig.backend_info.bSupportsGLSLUBO, C_MATERIALS, "int4", I_MATERIALS"[4]");
	DeclareUniform(out, api_type, g_ActiveConfig.backend_info.bSupportsGLSLUBO, C_LIGHT_COLORS,  "int4", I_LIGHT_COLORS"[8]");
	DeclareUniform(out, api_type, g_ActiveConfig.backend_info.bSupportsGLSLUBO, C_LIGHTS,  "float4", I_LIGHTS"[32]");
